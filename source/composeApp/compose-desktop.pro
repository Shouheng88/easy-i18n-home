...
# 数据模型
-keep class me.shouheng.i18n.manager.WordManager { *; }
-keep class me.shouheng.i18n.data.model.** { *; }
-keep class me.shouheng.i18n.net.ai.model.** { *; }
-keep class me.shouheng.i18n.net.server.model.** { *; }
-keep class me.shouheng.i18n.net.translator.model.** { *; }
